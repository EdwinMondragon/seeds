...
La Acetona no mejoró la germinación. Kader y Hosseini (2020) mostraron que solventes orgánicos pueden ser efectivos en Lens y Vigna cuando se ajusta el tiempo de inmersión; sin embargo, la exposición en garbanzo parece tener algún efecto fitotóxico provocando la muerte del embrión. 

Respecto a Agua caliente, la temperatura de 80 °C durante 5 min parece haber causado la muerte del embrión. Varios autores reportan que Cicer requiere ≥90 °C o un choque térmico seguido de enfriamiento brusco para obtener aperturas microscópicas (Saxena et al., 2002). Sin ese gradiente térmico, la permeabilidad apenas cambia.

</div>

## Índice de velocidad, vigor y coeficiente de variación

<div style="text-align: justify;">
El índice de velocidad de germinación (IVG) fue significativamente más alto en el tratamiento Lija (1,56), seguido por el Control (1,46), mientras que los tratamientos con Agua caliente y Acetona presentaron valores casi nulos. Este comportamiento reafirma la capacidad del lijado para acelerar el proceso germinativo. Asimismo, el tratamiento Lija presentó los valores más altos de vigor (VGT = 0,94) y un coeficiente de variación de la germinación (CVG = 38,6) levemente superior al Control (35,8), pero con menor dispersión absoluta en otras métricas, lo que sugiere mayor estabilidad del tratamiento.

El vigor es una variable crítica, ya que no solo implica que las semillas germinen, sino que lo hagan con suficiente energía para emerger y establecerse. Como lo señalan Finch-Savage y Bassel (2016), un vigor alto predice mejores desempeños en campo, especialmente bajo condiciones de estrés. En este sentido, el tratamiento Lija aportó ventajas claras.
</div>

## Sincronización de la germinación
<div st, el índice de sincronización (SYN) no mostró diferencias estadísticas entre Control y Lija (~0,34), el lijado presentó menor desviación estándar (±0,0445 vs ±0,0783), lo cual sugiere una germinación más homogénea entre repeticiones. En aplicaciones donde se requiere uniformidad temporal —como viveros, cultivos hidropónicos o ensayos fenotípicos— esta característica puede resultar crítica (Trudgill et al., 2000). La sincronía es especialmente importante en condiciones de competencia intraspecífica, donde la germinación escalonada puede generar desventajas competitivas en las últimas plántulas emergidas.
</div>
