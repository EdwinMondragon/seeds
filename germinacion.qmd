---
title: "Efecto de la escarificación física y química en la germinación de semillas de garbanzo (*Cicer arietinum*)"
author: "Edwin Mondragon-Jhinmy Paredes-Jhodany Parejas-Nixon Pizarro-Gimena Vega"
format:
  html:
    toc: true
    toc-location: left
...
kable(libro2, caption = "Tabla 3: Variables evaludas") %>%
  kable_styling(full_width = FALSE, bootstrap_options = c("striped", "hover", "condensed"))
```
